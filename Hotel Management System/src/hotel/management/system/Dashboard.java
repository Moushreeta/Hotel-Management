...
public class Dashboard extends JFrame{
    ...
    public Dashboard() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("hotel/management/system/icons/dashboard.png"));
	...
	NewLabel.setBounds(0, 0, 1950, 1000); 
        ...
        JLabel AirlineManagementSystem = new JLabel("CHRIST HOTEL WELCOMES YOU");
